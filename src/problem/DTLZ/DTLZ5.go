...
func (this *DTLZ5) NewDTLZ5(nd, no, nc int) {
	this.name = "DTLZ5"
...
func (this *DTLZ5) GetName() string {
	return this.name
}

func (this *DTLZ5) GetNumberOfObjectives() int {
	return this.numberOfObjectives
}

func (this *DTLZ5) GetNumberOfVariables() int {
	return this.numberOfVariables
}

func (this *DTLZ5) GetNumberOfConstraints() int {
	return this.numberOfConstraints
}

func (this *DTLZ5) CreateSolution() *solution.Solution {
...
func (this *DTLZ5) Evaluate(solution *solution.Solution) {
