...
func (this *LZ09_F1) NewLZ09_F1(nd, no, nc int) {
	this.name = "LZ09_F1"
...
func (this *LZ09_F1) GetName() string {
	return this.name
}

func (this *LZ09_F1) GetNumberOfObjectives() int {
	return this.numberOfObjectives
}

func (this *LZ09_F1) GetNumberOfVariables() int {
	return this.numberOfVariables
}

func (this *LZ09_F1) GetNumberOfConstraints() int {
	return this.numberOfConstraints
}

func (this *LZ09_F1) CreateSolution() *solution.Solution {
...
func (this *LZ09_F1) Evaluate(solution *solution.Solution) {
	lz09(30, 2, 21, 21, 1)
	evaluate(solution)
}
