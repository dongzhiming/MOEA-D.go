...
func (this *LZ09_F2) NewLZ09_F2(nd, no, nc int) {
	this.name = "LZ09_F2"
...
func (this *LZ09_F2) GetName() string {
	return this.name
}

func (this *LZ09_F2) GetNumberOfObjectives() int {
	return this.numberOfObjectives
}

func (this *LZ09_F2) GetNumberOfVariables() int {
	return this.numberOfVariables
}

func (this *LZ09_F2) GetNumberOfConstraints() int {
	return this.numberOfConstraints
}

func (this *LZ09_F2) CreateSolution() *solution.Solution {
...
func (this *LZ09_F2) Evaluate(solution *solution.Solution) {
	lz09(30, 2, 21, 22, 1)
	evaluate(solution)
}
