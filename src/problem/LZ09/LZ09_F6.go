...
func (this *LZ09_F6) NewLZ09_F6(nd, no, nc int) {
	this.name = "LZ09_F6"
...
func (this *LZ09_F6) GetName() string {
	return this.name
}

func (this *LZ09_F6) GetNumberOfObjectives() int {
	return this.numberOfObjectives
}

func (this *LZ09_F6) GetNumberOfVariables() int {
	return this.numberOfVariables
}

func (this *LZ09_F6) GetNumberOfConstraints() int {
	return this.numberOfConstraints
}

func (this *LZ09_F6) CreateSolution() *solution.Solution {
...
func (this *LZ09_F6) Evaluate(solution *solution.Solution) {
	lz09(10, 3, 31, 32, 1)
	evaluate(solution)
}
