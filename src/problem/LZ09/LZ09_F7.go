...
func (this *LZ09_F7) NewLZ09_F7(nd, no, nc int) {
	this.name = "LZ09_F7"
...
func (this *LZ09_F7) GetName() string {
	return this.name
}

func (this *LZ09_F7) GetNumberOfObjectives() int {
	return this.numberOfObjectives
}

func (this *LZ09_F7) GetNumberOfVariables() int {
	return this.numberOfVariables
}

func (this *LZ09_F7) GetNumberOfConstraints() int {
	return this.numberOfConstraints
}

func (this *LZ09_F7) CreateSolution() *solution.Solution {
...
func (this *LZ09_F7) Evaluate(solution *solution.Solution) {
	lz09(10, 2, 21, 21, 3)
	evaluate(solution)
}
