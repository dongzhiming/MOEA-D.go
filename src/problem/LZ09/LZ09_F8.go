...
func (this *LZ09_F8) NewLZ09_F8(nd, no, nc int) {
	this.name = "LZ09_F8"
...
func (this *LZ09_F8) GetName() string {
	return this.name
}

func (this *LZ09_F8) GetNumberOfObjectives() int {
	return this.numberOfObjectives
}

func (this *LZ09_F8) GetNumberOfVariables() int {
	return this.numberOfVariables
}

func (this *LZ09_F8) GetNumberOfConstraints() int {
	return this.numberOfConstraints
}

func (this *LZ09_F8) CreateSolution() *solution.Solution {
...
func (this *LZ09_F8) Evaluate(solution *solution.Solution) {
	lz09(10, 2, 21, 21, 4)
	evaluate(solution)
}
