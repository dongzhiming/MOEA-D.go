...
func (this *LZ09_F9) NewLZ09_F9(nd, no, nc int) {
	this.name = "LZ09_F9"
...
func (this *LZ09_F9) GetName() string {
	return this.name
}

func (this *LZ09_F9) GetNumberOfObjectives() int {
	return this.numberOfObjectives
}

func (this *LZ09_F9) GetNumberOfVariables() int {
	return this.numberOfVariables
}

func (this *LZ09_F9) GetNumberOfConstraints() int {
	return this.numberOfConstraints
}

func (this *LZ09_F9) CreateSolution() *solution.Solution {
...
func (this *LZ09_F9) Evaluate(solution *solution.Solution) {
	lz09(30, 2, 22, 22, 1)
	evaluate(solution)
}
