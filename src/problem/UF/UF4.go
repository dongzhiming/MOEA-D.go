...
func (this *UF4) NewUF4(nd, no, nc int) {
	this.name = "UF4"
...
func (this *UF4) GetName() string {
	return this.name
}

func (this *UF4) GetNumberOfObjectives() int {
	return this.numberOfObjectives
}

func (this *UF4) GetNumberOfVariables() int {
	return this.numberOfVariables
}

func (this *UF4) GetNumberOfConstraints() int {
	return this.numberOfConstraints
}

func (this *UF4) CreateSolution() *solution.Solution {
...
func (this *UF4) Evaluate(solution *solution.Solution) {
	...
	f[1] = 1.0 - x[0]*x[0] + 2.0*sum2/float64(count2)
